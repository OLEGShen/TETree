...
ax1_1.plot(x1_1, y1_1, label='w/o thoughts', color=colors[0], linestyle=linestyles[0], linewidth=4)
ax1_1.set_ylabel('money/distance', color=colors[0], **font)
ax1_1.tick_params(axis='y', labelcolor=colors[0])


ax2_1.plot(x2_1, y2_1, label="Coefficient of variation", color=colors[4], linestyle=linestyles[1], linewidth=4)
ax2_1.set_ylabel('Coefficient of variation', color=colors[4], **font)
ax2_1.tick_params(axis='y', labelcolor=colors[4])


fig1.suptitle('w/o thoughts', **font, y=0.95)  # 调整标题垂直位置，y 值越小，距离图越近
...
ax1_2.plot(x1_2, y1_2, label="w/o R&S CoT", color=colors[1], linestyle=linestyles[0], linewidth=4)
ax1_2.set_ylabel('Keyword Count', color=colors[1], **font)
ax1_2.tick_params(axis='y', labelcolor=colors[1])


ax2_2.plot(x2_2, y2_2, label="Coefficient of variation", color=colors[4], linestyle=linestyles[1], linewidth=4)
ax2_2.set_ylabel('Coefficient of variation', color=colors[4], **font)
ax2_2.tick_params(axis='y', labelcolor=colors[4])


fig2.suptitle('w/o R&S CoT', **font, y=0.95)  # 调整标题垂直位置，y 值越小，距离图越近
...
ax1_3.plot(x1_3, y1_3, label="w/o cluster", color=colors[2], linestyle=linestyles[0], linewidth=4)
ax1_3.set_ylabel('Keyword Count', color=colors[2], **font)
ax1_3.tick_params(axis='y', labelcolor=colors[2])


ax2_3.plot(x2_3, y2_3, label="Coefficient of variation", color=colors[4], linestyle=linestyles[1], linewidth=4)
ax2_3.set_ylabel('Coefficient of variation', color=colors[4], **font)
ax2_3.tick_params(axis='y', labelcolor=colors[4])


fig3.suptitle('w/o cluster', **font, y=0.95)  # 调整标题垂直位置，y 值越小，距离图越近
...
ax1_4.plot(x1_4, y1_4, label='TeTree', color=colors[3], linestyle=linestyles[0], linewidth=4)
ax1_4.set_ylabel('Keyword Count', color=colors[3], **font)
ax1_4.tick_params(axis='y', labelcolor=colors[3])


ax2_4.plot(x2_4, y2_4, label="Coefficient of variation", color=colors[4], linestyle=linestyles[1], linewidth=4)
ax2_4.set_ylabel('Coefficient of variation', color=colors[4], **font)
ax2_4.tick_params(axis='y', labelcolor=colors[4])


fig4.suptitle('TeTree', **font, y=0.95)  # 调整标题垂直位置，y 值越小，距离图越近
...
lines1 = [plt.Line2D([0], [0], color=colors[0], linestyle=linestyles[0], label='w/o thoughts'),
         ...
         plt.Line2D([0], [0], color=colors[4], linestyle=linestyles[1], label='Coefficient of variation')]
